...
Template['layout_sidebar'].helpers({
    ...
    */
    'name': function () {
        return (this._id === 'browser') ? TAPi18n.__('divan.sidebar.buttons.browser') : this.name;
    },
    /**
...
Template['layout_sidebar'].events({
    ...
    */
    'click nav ul.sub-menu button': function (e, template) {
        ...
        // dapp tab
            ...
            webview.send('divanAPI_callMenuFunction', this.id);
    ...
    */
    'click .accounts button': function (e, template) {
        ...
        divan.requestAccount(function (ev, addresses) {
