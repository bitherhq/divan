...
!define GROUPNAME "Bither"
!define HELPURL "https://github.com/bitherhq/divan/releases/issues"
!define UPDATEURL "https://github.com/bitherhq/divan/releases"
!define ABOUTURL "https://bither.io"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Bither"
...
## Select the location for Divan's data directory
#PageEx directory
#  DirText "Select a location for Divan's data files (watched contracts, etc.)"
#  DirVar $DATADIR
#PageExEnd
...
# Divan installer instructions
Section Divan DIVAN_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Geth incoming peers (TCP:41207)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Bither" 41207 "" "" ""
    #SimpleFC::AdvAddRule "Geth outgoing peers (TCP:41207)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Bither" "" 41207 "" ""
    #SimpleFC::AdvAddRule "Geth UDP discovery (UDP:41207)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Bither" "" 41207 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:41207)"
    #SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:41207)"
    #SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:41207)"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${DIVAN_IDX}
