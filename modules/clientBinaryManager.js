...
// should be       'https://raw.githubusercontent.com/bitherhq/divan/master/clientBinaries.json'
const BINARY_URL = 'https://raw.githubusercontent.com/bitherhq/divan/master/clientBinaries.json';
        ...
        .catch((err) => {
            ...
            if (err.message.indexOf('Hash mismatch') !== -1) {
                ...
                dialog.showMessageBox({
                    type: 'warning',
                    buttons: ['OK'],
                    message: global.i18n.t('divan.errors.nodeChecksumMismatch.title'),
                    detail: global.i18n.t('divan.errors.nodeChecksumMismatch.description', {
                        type: nodeInfo.type,
