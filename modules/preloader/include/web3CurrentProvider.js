/**
Sets the bither provider, as well as "web3" for backwards compatibility.

@module bitherProvider
*/
...
// SET Bither PROVIDER
// window.bitherProvider = new Web3.providers.IpcProvider('', ipcProviderWrapper);
