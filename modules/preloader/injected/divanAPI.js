...
(function () {
    ...
    window.addEventListener('message', function(event) {
        ...
        if (data.type === 'divanAPI_callMenuFunction') {
            var id = data.message;
            ...
            if (divan.callbacks[params.type]) {
                divan.callbacks[params.type].forEach(function(cb) {
                    cb(params.error, params.value);
                });
                delete divan.callbacks[params.type];
            }
        }
    });
