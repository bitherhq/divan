...
(function () {
    ...
    BitherProvider.prototype = Object.create(EventEmitter.prototype);
    BitherProvider.prototype.constructor = BitherProvider;
     ...
     */
    BitherProvider.prototype._addResponseCallback = function(payload, callback) {
        var id = payload.id || payload[0].id;
        var method = payload.method || payload[0].method;

        if (typeof callback !== 'function') {
           throw new Error('No callback given, sync calls are not possible anymore in Divan. Please use only async calls.');
        }
     ...
     */
    BitherProvider.prototype._reconnectCheck = function() {
        var _this = this;
    ...
    /**
     ...
     @method connect
     */
    BitherProvider.prototype._connect = function(payload, callback) {
        postMessage({
            type: 'create'
        });
    };
    ...
    BitherProvider.prototype.send = function send(payload, callback) {
    ...
    // TODO set real bither provider
    // window.bither = new BitherProvider();


    // For backwards compatibility of web3.currentProvider;
    BitherProvider.prototype.sendSync = function () {
        return {jsonrpc: '2.0', error: {"code": -32603, message: 'Sync calls are not anymore supported in Divan :\\'}};
    };
    BitherProvider.prototype.sendAsync = BitherProvider.prototype.send;
    BitherProvider.prototype.isConnected = function () {
        return true;
    };
    window.web3 = {
        currentProvider: new BitherProvider()
    };
})();
